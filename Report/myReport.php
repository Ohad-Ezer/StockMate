                                ...
                                if ($conn->connect_error) {
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            $creator_name = $row["username"];
                                            $notes = $row["notes"];
                                            $reportURL = 'anotherpage.html?stock_symbol=' .$stock_symbol . '&start_date=' . $start_date . '&end_date=' . $end_date . '&created_at=' . $created_at . '&creator_name=' . $creator_name . '&notes=' . $notes;                                            
